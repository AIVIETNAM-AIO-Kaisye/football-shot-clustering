...
| Giải | World Cup 2018 (`comp=43, season=3`) + World Cup 2022 (`comp=43, season=106`) |
...
Đo thực tế trên World Cup 2018 (1.304 shot hợp lệ): `under_pressure` chỉ có ở **387** dòng, `first_time` **380**,
...
36 penalty + 24 quả luân lưu trong World Cup 2018, tất cả ở **cùng một toạ độ**, xG cố định ~0.78.
...
Đo thực tế: **100%** shot của World Cup 2018 có `freeze_frame` (1304/1304) → **không cần 360 data**.
